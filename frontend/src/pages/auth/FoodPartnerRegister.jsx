...
const FoodPartnerRegister = () => {
  ...
  const handleSubmit = (e) => {
    ...
    if (!businessName || !contactName || !phone || !email || !password || !address) {
      setError('Please fill in all fields: business name, contact name, phone, email, password, and address.');
      return;
    }
    ...
    axios.post("http://localhost:3000/api/auth/food-partner/register", {
      ...
      .then(response => {
        ...
        setSuccess('Partner account created! Redirecting...');
        setTimeout(() => navigate("/create-food"), 700); // Redirect to create food page after successful registration
      })
      .catch(error => {
